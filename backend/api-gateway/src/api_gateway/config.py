            ...
            ServiceConfig(
                ...
                endpoints=[
                    EndpointConfig(
                        name="SearchByText",
                        method="POST",
                        gateway_path="/api/v1/search/text",
                        service_path="/api/v1/search/text",
                        summary="Search for images by text description.",
                    ),
                    EndpointConfig(
                        name="SearchByEmbedding",
                        method="POST",
                        gateway_path="/api/v1/search/embedding",
                        service_path="/api/v1/search/embedding",
                        summary="Search for images by embedding vector.",
                    ),
                    EndpointConfig(
                        name="SearchByImage",
                        method="POST",
                        gateway_path="/api/v1/search/image",
                        service_path="/api/v1/search/image",
                        summary="Search for images by image URL.",
                    ),
                ],
            ),
        ]
