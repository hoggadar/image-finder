...
HOST = os.environ.get("CONFIG__DB__HOST")  
PORT = os.environ.get("CONFIG__DB__PORT")  
DATABASE = os.environ.get("CONFIG__DB__DATABASE")  
USER = os.environ.get("CONFIG__DB__USER")  
PASSWORD = os.environ.get("CONFIG__DB__PASSWORD")  
