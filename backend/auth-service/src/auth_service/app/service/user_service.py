...
class UserServiceImpl(UserService):
    ...
    async def update(self, dto: UpdateUserDTO) -> Optional[UserDTO]:
        try:
            ...
            if existing_user.username != dto.username:
                ...
                if user_with_username and user_with_username.id != dto.id:
            ...
            if existing_user.email != dto.email:
                ...
                if user_with_email and user_with_email.id != dto.id:
    ...
    async def change_password(self, dto: ChangePasswordDTO):
